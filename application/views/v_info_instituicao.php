			...
			<section class="box-typical box-panel mb-4">
				<div class="widget-container fluid-height">
					...
					<?php if($tipo_tela=='nova'):?>
						<form action="<?= base_url("instituicoes/cadastrar?id_instituicao=0")?>" method="post">
					<?php else: ?>
						<form action="<?= base_url("instituicoes/salvar_edicao?id_instituicao={$id_instituicao}")?>" method="post">
					<?php endif ?>
